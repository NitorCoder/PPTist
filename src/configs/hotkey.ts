...
export const HOTKEY_DOC = [
  {
    ...
    children: [
      ...
      { label: 'Dán dưới dạng văn bản thuần', value: 'Ctrl + Shift + V' },
      { label: 'Sao chép và dán nhanh', value: 'Ctrl + D' },
      { label: 'Chọn tất cả', value: 'Ctrl + A' },
      { label: 'Hoàn tác', value: 'Ctrl + Z' },
      { label: 'Phục hồi', value: 'Ctrl + Y' },
      { label: 'Xóa', value: 'Delete / Backspace' },
      { label: 'Chọn nhiều', value: 'Nhấn và giữ Ctrl và Shift' },
      { label: 'Mở tìm kiếm và thay thế', value: 'Ctrl + F' },
      { label: 'In', value: 'Ctrl + P' },
      { label: 'Đóng cửa sổ pop-up', value: 'ESC' },
    ],
  },
  {
    type: '幻灯片放映',
